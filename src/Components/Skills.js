...
//             <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-8 text-center">My Expertise</h2>
//             <section>
...
//                                 <button
//                                     key={index}
//                                     className="flex items-center bg-white border-2 border-gray-300 rounded-lg px-4 py-2 text-gray-800 text-sm sm:text-base font-medium shadow-md transition-transform transform hover:bg-gray-100 hover:border-gray-500 hover:text-gray-900 hover:scale-105"
//                                     style={{ 
...
//                         </div>
//                     </div>
//                     <div className="w-full sm:w-1/3 flex items-center justify-center mt-8 sm:mt-0">
//                         <img 
//                             src={techs} 
//                             alt="Technologies" 
//                             className="max-w-xs sm:max-w-full rounded-full border-4 border-red-500 shadow-md hover:shadow-xl transition-shadow transform hover:scale-105" 
//                         />
//                     </div>
//                 </div>
//             </section>
